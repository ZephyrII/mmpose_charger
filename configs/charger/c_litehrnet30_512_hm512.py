...
log_level = 'INFO'
load_from = None
ex_name = "c_litehrnet_udp_512_hm512"
# resume_from = "/home/tomasz/PhD/charger/mmpose_charger/work_dirs/c_litehrnet30_512_hm512/epoch_6.pth"
resume_from = None
    ...
    hooks=[
        ...
        dict(type='NeptuneLoggerHook',
            init_kwargs=dict(
                ...
                name=ex_name,
                tags=["LiteHRNet", "512", "HM512", "aug", "batch4"])
            )
    ])
