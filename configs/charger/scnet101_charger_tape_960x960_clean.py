...
log_level = 'INFO'
load_from = None
resume_from = "/root/mmpose/work_dirs/scnet101_charger_tape_960x960_clean/latest.pth"
# resume_from = None
...
data_root = '/root/share/tf/dataset/final_localization/tape_1.0'
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=1,
